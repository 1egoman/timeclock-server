...
User.statics.sendWelcomeMailer = function(user) {
  if (user.email) {
    return mail.send({
      subject: `Welcome to Waltz, ${user.email}`,
      ...
      <body bgcolor="#eee" style="background:#eee;padding:64px;">
        ...
        <div style="width:500px;margin:64px auto;background:#FFF;padding:20px;">
          <h2>Hey, you're awesome.</h2>
          <p>
            Thanks for signing up for Waltz. You;ve now made invoices a lot
            easier and look better at the same time.
            We know you'll love it as much as we do
          </p>
          <a target="_blank" href="http://waltzapp.co/app/">
            Take me to the app
          </a>
